...
var fruit_list = ['apple', 'orange', 'mango', 'watermelon', 'cherry','banana'];//List of fruits
var fruit_topic = ['Fruit', 'Fruit', 'Fruit', 'Fruit', 'Fruit','Fruit'];//List of topics
var fruit_hint = ['The fruit is red', 'The fruit is named after a color', 'The fruit is commonly red and green', 'It is big and green', 'The fruit is red small and sweet','It is yellow and can be used to make delicious bread'];//Hint for fruit generated

var super_hero_list = ['the_flash', 'iron_man', 'spider-man', 'batman', 'superman','captain_america'];//Super hero list
var super_hero_topic = ['DC Super Heros', 'Marvel Super Heros', 'Marvel Super Heros', 'DC Super Hero', 'DC Super Hero','Marvel'];//Topic for super hero
var super_hero_hint = ['He is very fast', 'I am ...', 'Friendly neighborhood', 'I am the vengeance! I am the Night! I am ...', 'The Last Son of Krypton','I can do this all day'];//Hint for super hero generated

var school_subject_list = ['math', 'english', 'history', 'science', 'gym','Art'];
var school_subject_topic = ['School Subject', 'School Subject', 'School Subject', 'School Subject', 'School Subject','School Subject'];
var school_subject_hint = ['Numbers', 'Writing', 'Past events', 'Experiments', 'Working Out','Bob Ross'];

var popular_brands_list = ['nike','apple','mircosoft','adidas','sony','disney'];
var popular_brands_topic = ['Popular Brands', 'Popular Brands', 'Popular Brands', 'Popular Brands', 'Popular Brands', 'Popular Brands'];
var popular_brands_hint = ['Just Do It!', 'Think Different', 'We believe in what people make possible', 'Impossible Is Nothing', 'Make. Believe','The Happiest Place on Earth']

var cartoons_list = ['tom_and_jerry','teenage_mutant_ninja_turtles','spongebob_squarepants','gravity_falls','star_wars:_the_clone_wars','transformers'];
var cartoons_topic = ['Cartoons', 'Cartoons', 'Cartoons', 'Cartoons', 'Cartoons', 'Cartoons'];
var cartoon_hint = ['Cat and mouse','... In a Half Shell','Ohh Who lives in a Pineapple Under the Sea','Bill is watching','It\'s a trap!','Autobots Roll Out'];

var video_games = ['the_last_of_us','god_of_war','pokemon','mario','halo','zelda'];
var video_games_topic = ['Video Games', 'Video Games', 'Video Games', 'Video Games', 'Video Games', 'Video Games'];
var video_games_hint = ['When your lost look towards the light. Believe in the Fireflies','Boyy!','Gotta Catch Them All','It\'s a me ...','I need a weapon','It is dangerous out there. Here take this.'];

const words_list = fruit_list.concat(super_hero_list, school_subject_list, popular_brands_list, cartoons_list, video_games);//Combines the list
const topic_list = fruit_topic.concat(super_hero_topic, school_subject_topic, popular_brands_topic, cartoons_topic, video_games_topic);//Combines the topic list
